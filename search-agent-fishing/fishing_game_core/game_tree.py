...
class State:
    ...
    def __str__(self):
        ...
        s += 'player_scores: ' + str(self.player_scores) + '\n'
        s += 'player_caught: ' + str(self.player_caught) + '\n'
        s += 'hook_positions  ' + str(self.hook_positions)  + '\n'
        s += 'fish_positions ' + str(self.fish_positions )  + '\n'
        s += 'fish_scores ' + str(self.fish_scores )  + '\n'
        return s 
