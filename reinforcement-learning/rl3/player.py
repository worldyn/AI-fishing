...
def epsilon_greedy(Q,
    ...
    if eps_type == 'constant':
        ...
        print("anneal timesteps =", current_total_steps)
        # ADD YOUR CODE SNIPPET BETWEENEX  3.2
    ...
    if p < epsilon: # prob epsilon
        ...
        action_idx = np.random.randint(0,num_a-1)               
    ...
    def q_learning(self):
        ...
        while episode <= self.episode_max and diff >= self.threshold:
            ...
            while not end_episode:
                ...
                '''
                possible_actions = self.allowed_moves[s_current]
                num_a = len(possible_actions)
                action_idx = random.randint(0,num_a-1)               
                ...
                msg = self.receiver()
                #print("Q after getting message: ",Q)
            ...
            #not sure because if Q is 2-D array and what is returned
            #Also do we need to store the value which will be trash?
