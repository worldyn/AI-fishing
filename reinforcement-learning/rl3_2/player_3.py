...
def epsilon_greedy(Q,
    ...
    if eps_type == 'constant':
        ...
        # It is recommended you use the np.random module
        #print("linear")
        #print("anneal_timesteps: ", anneal_timesteps)
        #print("current_tot_steps: ", current_total_steps)
...
class PlayerControllerRL(PlayerController, FishesModelling):
    ...
    def player_loop(self):
        ...
        self.init_actions()
        self.init_states()
        self.alpha = 0.2#self.settings.alpha
        self.gamma = 0.8#self.settings.gamma
